        ...
        <div class="container-cabecalho">
            <div class="cabecalho-esquerda">
                ...
                <nav class="navegacao-mes">
                    ...
                    <a href="?mes=<?= date('Y-m') ?>" class="botao-mes-atual">Mês 
 Atual</a>
        ...
        <div class="grid-lancamentos">
            ...
            <section class="card-painel acordeao-item abrir-em-desktop">
                <div class="acordeao-cabecalho card-titulo" data-acao="alternar-acordeao">
                    ...
                    <div class="cabecalho-direita">
                        <strong id="total-contas-variaveis" 
 class="total-terceiro"></strong>
                        <span class="icone-expandir">
                           <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/></svg>
        ...
        <div class="grid-lancamentos">
            <section class="card-painel acordeao-item abrir-em-desktop">
                <div class="acordeao-cabecalho card-titulo" data-acao="alternar-acordeao">
                 ...
                 <div class="acordeao-corpo">
                    <div id="container-contas-morr" class="acordeao-corpo-conteudo" style="padding: 
 0 1rem 1rem 1rem;">
            ...
            <section class="card-painel acordeao-item abrir-em-desktop">
                <div class="acordeao-cabecalho card-titulo" data-acao="alternar-acordeao">
                    ...
                    <div class="cabecalho-direita">
                        ...
                        <span class="icone-expandir">
                             <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 
 0l-6-6a.5.5 0 0 1 0-.708z"/></svg>
                        </span>
                    </div>
                </div>
                 <div class="acordeao-corpo">
            ...
            <section class="card-painel acordeao-item abrir-em-desktop">
                <div class="acordeao-cabecalho card-titulo" data-acao="alternar-acordeao">
                    ...
                    <div 
 class="cabecalho-direita">
                        <strong id="total-contas-vo" class="total-terceiro"></strong>
                        <span class="icone-expandir">
                             <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 
 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/></svg>
                        </span>
                    </div>
                </div>
                <div class="acordeao-corpo">
  ...
  <div id="modal-detalhes-cartao" class="modal-camada-externa" style="display:none;">
    <div 
 class="modal-conteudo modal-grande">
      <header class="modal-cabecalho">
